...
const artifactDetails = {
  "darwin-aarch64": { extension: ".app.tar.gz", output: "darwin-aarch64.app.tar.gz", bundleDirectory: "macos" },
  "darwin-x86_64": { extension: ".app.tar.gz", output: "darwin-x86_64.app.tar.gz", bundleDirectory: "macos" },
  "windows-x86_64": { extension: ".exe", output: "windows-x86_64-setup.exe", bundleDirectory: "nsis" },
};
...
function main() {
  ...
  if (!artifact) throw new Error(`Could not find a ${details.extension} updater bundle for ${platform}.`);
  ...
  cpSync(`${artifact}.sig`, `${destination}.sig`);
