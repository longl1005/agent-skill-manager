...
export const dict = {
  zh: {
    ...
    "installSkills.tabOnline": "🌐 全网 11,000+ 技能检索",
    "installSkills.tabUrl": "🔗 Git / GitHub 网址安装",
    "installSkills.tabLocal": "📁 本地目录导入",
    "installSkills.searchOnlinePlaceholder": "输入关键词搜索全网 11,000+ 开源 Agent 技能 (例如 react, python, search, git)...",
    "installSkills.searching": "正在检索全网开源技能...",
  ...
  en: {
    ...
    "installSkills.tabOnline": "🌐 Live Online Search",
    "installSkills.tabUrl": "🔗 Git / URL Import",
    "installSkills.tabLocal": "📁 Local Import",
    "installSkills.searchOnlinePlaceholder": "Search 11,000+ open-source agent skills by keyword...",
    "installSkills.searching": "Searching global registry...",
