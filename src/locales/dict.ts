...
export const dict = {
  zh: {
    ...
    "installSkills.tabOnline": "⚡ skills.sh 官方全量库",
    "installSkills.tabUrl": "🔗 Git / GitHub 网址安装",
    "installSkills.tabLocal": "📁 本地目录导入",
    "installSkills.searchOnlinePlaceholder": "搜索 skills.sh 官方全量技能 (如 frontend-design, tdd, web, react)...",
  ...
  en: {
    ...
    "installSkills.tabOnline": "⚡ skills.sh Directory",
    "installSkills.tabUrl": "🔗 Git / URL Import",
    "installSkills.tabLocal": "📁 Local Import",
    "installSkills.searchOnlinePlaceholder": "Search skills.sh directory...",
