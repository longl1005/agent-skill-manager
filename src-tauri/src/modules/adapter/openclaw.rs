//! OpenClaw adapter.
//!
//! OpenClaw stores user skills in `$HOME/.openclaw/skills`, using the same
...
impl AgentAdapter for OpenClawAdapter {
    ...
    fn capabilities(&self) -> CapabilitySet {
        CapabilitySet {
            ...
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            notes: vec!["user-scope $HOME/.openclaw/skills".into()],
        }
    }
    ...
    fn detect(&self, ctx: &DetectContext) -> DetectionResult {
        ...
        let base_dir = home.join(".openclaw");
    ...
    fn scan(&self, ctx: &ScanContext) -> ScanResult {
        ...
        for installation in &mut result.installations {
            ...
            installation.adapter_id = "openclaw@1".into();
        }
        result
    }
}
