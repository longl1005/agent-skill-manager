...
impl AgentAdapter for CursorAdapter {
    ...
    fn descriptor(&self) -> AgentDescriptor {
        AgentDescriptor {
            agent_id: self.id(),
            adapter_id: "cursor@1".to_string(),
            display_name: "Cursor".to_string(),
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            documentation_url: Some("https://cursor.com".to_string()),
    ...
    fn capabilities(&self) -> CapabilitySet {
        CapabilitySet {
            ...
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            notes: vec!["user-scope $HOME/.cursor/skills".to_string()],
        }
    }
    ...
    fn detect(&self, ctx: &DetectContext) -> DetectionResult {
        ...
        if roots.is_empty() {
            issues.push(ScanIssue {
                ...
                phase: IssuePhase::Detect,
                path: None,
                message: "no Cursor Skills roots found".into(),
                recoverable: true,
            });
        }
...
fn build_installation_full(
    ...
    SkillInstallation {
        ...
        format: SkillFormatDescriptor {
            id: "cursor-skill".into(),
            display_name: "Cursor Skill".into(),
...
mod tests {
    ...
    fn tempdir() -> PathBuf {
        ...
        let nanos = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let p = std::env::temp_dir().join(format!("asm-cursor-{}-{}-{}", pid, nanos, n));
    ...
    fn cursor_detect_only_user() {
        ...
        let r = CursorAdapter.detect(&ctx);
