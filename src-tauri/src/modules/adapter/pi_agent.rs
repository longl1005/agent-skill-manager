...
impl AgentAdapter for PiAgentAdapter {
    fn id(&self) -> AgentId {
        AgentId("pi-agent".to_string())
    }

    fn descriptor(&self) -> AgentDescriptor {
        AgentDescriptor {
            agent_id: self.id(),
            adapter_id: "pi-agent@1".to_string(),
            display_name: "Pi Agent".to_string(),
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            documentation_url: Some("https://pi.ai".to_string()),
    ...
    fn capabilities(&self) -> CapabilitySet {
        CapabilitySet {
            ...
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            notes: vec!["user-scope $HOME/.pi/skills".to_string()],
        }
    }
    ...
    fn detect(&self, ctx: &DetectContext) -> DetectionResult {
        ...
        let candidate_roots = [
            ...
            home.join(".pi-agent").join("skills"),
        ];
        ...
        if roots.is_empty() {
            issues.push(ScanIssue {
                ...
                phase: IssuePhase::Detect,
                path: None,
                message: "no Pi Agent Skills roots found".into(),
                recoverable: true,
            });
        }
...
fn build_installation_full(
    ...
    SkillInstallation {
        ...
        format: SkillFormatDescriptor {
            id: "pi-agent-skill".into(),
            display_name: "Pi Agent Skill".into(),
...
mod tests {
    ...
    fn tempdir() -> PathBuf {
        ...
        let nanos = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let p = std::env::temp_dir().join(format!("asm-pi-{}-{}-{}", pid, nanos, n));
    ...
    fn pi_agent_detect_only_user() {
        ...
        let r = PiAgentAdapter.detect(&ctx);
