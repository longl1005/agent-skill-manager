//! Roo Code adapter.
//!
//! Roo Code stores user-level skills in `$HOME/.roo/skills`.
...
impl AgentAdapter for RooCodeAdapter {
    fn id(&self) -> AgentId {
        AgentId("roo-code".to_string())
    }

    fn descriptor(&self) -> AgentDescriptor {
        AgentDescriptor {
            agent_id: self.id(),
            adapter_id: "roo-code@1".into(),
            display_name: "Roo Code".into(),
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            documentation_url: Some("https://roocodeinc.github.io/Roo-Code/features/skills/".into()),
    ...
    fn capabilities(&self) -> CapabilitySet {
        CapabilitySet {
            ...
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            notes: vec!["user-scope $HOME/.roo/skills".into()],
        }
    }
    ...
    fn detect(&self, ctx: &DetectContext) -> DetectionResult {
        ...
        let base_dir = home.join(".roo");
        let alt_base_dir = home.join(".roo-code");
    ...
    fn scan(&self, ctx: &ScanContext) -> ScanResult {
        ...
        for installation in &mut result.installations {
            ...
            installation.adapter_id = "roo-code@1".into();
        }
        result
    }
}
