//! Augment adapter.
//!
//! Augment stores user-level skills in `$HOME/.augment/skills`.
...
impl AgentAdapter for AugmentAdapter {
    fn id(&self) -> AgentId {
        AgentId("augment".to_string())
    }

    fn descriptor(&self) -> AgentDescriptor {
        AgentDescriptor {
            agent_id: self.id(),
            adapter_id: "augment@1".into(),
            display_name: "Augment".into(),
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            documentation_url: Some("https://docs.augmentcode.com/cli/skills".into()),
    ...
    fn capabilities(&self) -> CapabilitySet {
        CapabilitySet {
            ...
            supported_platforms: vec![Platform::MacOs, Platform::Linux, Platform::Windows],
            notes: vec!["user-scope $HOME/.augment/skills".into()],
        }
    }
    ...
    fn detect(&self, ctx: &DetectContext) -> DetectionResult {
        ...
        let base_dir = home.join(".augment");
    ...
    fn scan(&self, ctx: &ScanContext) -> ScanResult {
        ...
        for installation in &mut result.installations {
            ...
            installation.adapter_id = "augment@1".into();
        }
        result
    }
}
